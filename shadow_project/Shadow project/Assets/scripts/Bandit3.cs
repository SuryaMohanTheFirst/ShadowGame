...
public class Bandit3 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (lightHandler.GetComponent<LightHandler>().shadow && Input.GetButtonDown(diveInput))
        {
            dive();
        }
    ...
    private void dive()
    {
        ...
        {
            print("diving");
            m_body2d.velocity = Vector2.down * diveSpeed;
            airborne = false;
        }
